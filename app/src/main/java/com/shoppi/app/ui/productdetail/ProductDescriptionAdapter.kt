...
class ProductDescriptionAdapter : ListAdapter<Description, ProductDescriptionAdapter.DescriptionViewHolder>(
    ...
    inner class DescriptionViewHolder(private val binding: ItemProductDescriptionBinding) :
